...
import AddEmailTempleteModal from "../Modals/AddEmailTempleteModal";
...
const EmailTemplete = ({ t, show, setShow, getEmailTemplete, id, setId, setLoading, tableParams, setTableParams, setkeyword, data, loading }) => {
    const messageModalRef = useRef('');
    const today = dayjs().format("MM-DD-YYYY");
    const exportToExcel = (data, fileName = "email_templetes_lists.xlsx") => {
    ...
    //               PDF EXPORT FUNCTION
    // =======================================================
    const exportToPDF = (columns, data, fileName = "email_templetes_lists.pdf") => {
        const doc = new jsPDF();
    ...
    const tableSMSTempleteMangement = {
        ...
        columns: [
            ...
            },
            {
                ...
                key: "message",
                render:((_, record) =>(
                    <span>{getTextFromHTML(record?.message)}</span>
                )),
    ...
    return (
        <div>
            ...
            <AddEmailTempleteModal
                getEmailTemplete={getEmailTemplete} id={id}
